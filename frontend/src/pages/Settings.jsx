...
export default function Settings({ apiHost, leads = [], reloadLeads, currentUser, setCurrentUser }) {
  ...
  return (
    <div className="space-y-6">
      {/* Title Header */}
      <div>
        <h2 className="text-2xl font-display font-extrabold text-fg">Configurations & Outils</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8">
          <div className="bg-surface border border-line rounded-2xl p-6 shadow-sm h-full">
            <h3 className="font-display font-extrabold text-fg text-lg mb-2 flex items-center gap-2">
            ...
            {sending.pausedAt ? (
              <div className="p-4 rounded-xl text-sm flex items-start gap-3 border bg-[var(--wt-danger-soft)] border-line text-[var(--wt-danger-fg)]">
                <X className="w-5 h-5 text-[var(--wt-danger)] flex-shrink-0 mt-0.5" />
                <span>
              ...
              <div className="p-4 rounded-xl text-sm flex items-start gap-3 border bg-[var(--wt-success-soft)] border-line text-[var(--wt-success-fg)]">
                <Check className="w-5 h-5 text-[var(--wt-success)] flex-shrink-0 mt-0.5" />
                <span>
              ...
              <div className="p-4 rounded-xl text-sm flex items-start gap-3 border bg-[var(--wt-warning-soft)] border-line text-[var(--wt-warning-fg)]">
                <Info className="w-5 h-5 text-[var(--wt-warning)] flex-shrink-0 mt-0.5" />
                <span>
              ...
              <div className="p-4 rounded-xl text-sm flex items-start gap-3 border bg-surface-2 border-line text-fg">
                <RefreshCw className="w-5 h-5 text-accent flex-shrink-0 mt-0.5 animate-spin" />
                <span>
            ...
            <div className="flex flex-wrap gap-3 pt-6 mt-6 border-t border-line">
              <button
                type="button"
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-surface border border-line text-fg font-semibold text-sm shadow-sm hover:bg-surface-2 active:scale-95 transition-all duration-150"
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* User Profile Card */}
          <div className="bg-surface border border-line rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between">
            <div className="space-y-4 w-full">
              ...
              {profileError && (
                <p className="bg-[var(--wt-danger-soft)] text-[var(--wt-danger)] text-xs p-3 rounded-lg font-semibold border border-line">{profileError}</p>
              )}

              <div>
                <label className="block text-xs font-bold text-fg-muted uppercase tracking-wider mb-2">Nom complet *</label>
                <input 
              ...
              <div>
                <label className="block text-xs font-bold text-fg-muted uppercase tracking-wider mb-2">Adresse E-mail *</label>
                <input 
              ...
              <div>
                <label className="block text-xs font-bold text-fg-muted uppercase tracking-wider mb-2">Numéro de téléphone (Optionnel)</label>
                <input 
                  type="tel" className="w-full bg-surface-2 border border-line rounded-xl px-4 py-3 text-fg text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all"
            ...
            <button 
              type="button" 
              className="w-full mt-6 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-accent text-white font-semibold text-sm shadow-sm hover:bg-accent active:scale-95 transition-all duration-150"
          ...
          <div className="bg-surface border border-line rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between">
            <div className="space-y-4 w-full">
              ...
              <div>
                <label className="block text-xs font-bold text-fg-muted uppercase tracking-wider mb-2">Nom de votre SaaS</label>
                <input 
                  type="text" className="w-full bg-surface-2 border border-line rounded-xl px-4 py-3 text-fg text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all"
              ...
              <div>
                <label className="block text-xs font-bold text-fg-muted uppercase tracking-wider mb-2">Site Internet de base</label>
                <input
                  type="text" className="w-full bg-surface-2 border border-line rounded-xl px-4 py-3 text-fg text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all"
              ...
              <div>
                <label className="block text-xs font-bold text-fg-muted uppercase tracking-wider mb-2">Signature par défaut</label>
                <textarea
                  className="w-full bg-surface-2 border border-line rounded-xl px-4 py-3 text-fg text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all min-h-[120px] font-mono text-xs"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-surface border border-line rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between">
          <div>
            <h3 className="font-display font-extrabold text-fg text-lg mb-3 flex items-center gap-2">
            ...
            <div className="flex items-start gap-3 bg-surface-2 border border-line p-4 rounded-xl mb-6">
          ...
          <button 
            type="button" 
            className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-surface border border-line text-fg font-semibold text-sm shadow-sm hover:bg-surface-2 active:scale-95 transition-all duration-150"
        ...
        <div className="bg-surface border border-line rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between">
          <div>
            ...
            <div className="mb-4">
              <textarea 
                className="w-full bg-surface-2 border border-line rounded-xl px-4 py-3 text-fg text-xs focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all min-h-[100px] font-mono" 
