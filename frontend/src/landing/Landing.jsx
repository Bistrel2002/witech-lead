...
const STEPS = [
  ...
  { icon: Send, title: 'Envoyer', text: 'Vos e-mails partent depuis un domaine d’envoi qui vous est réservé. Aucune configuration technique de votre part.' },
      ...
      <main>
        <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
          ...
          <p className="text-fg-muted text-lg mt-6 max-w-2xl mx-auto">
            ...
            automatiquement, et suivez l’avancement de chaque prospect — dans un seul outil.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-3 mt-9">
            <Button href={CONTACT} icon={Mail}>Demander un accès</Button>
            <Button href="#tarifs" variant="secondary">Voir les tarifs</Button>
          </div>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <h2 className="font-display font-extrabold text-3xl text-fg text-center mb-10">
            De la recherche au suivi, en quatre étapes
          </h2>
          {/* 1 -> 2 -> 4 columns. Going straight to four at md left roughly
              118px of text per card at iPad-portrait width. */}
          ...
          <div className="bg-surface border border-line rounded-3xl p-8 md:p-12 shadow-[var(--wt-shadow)]">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="space-y-3">
                {[
                  { icon: ShieldCheck, t: 'Un domaine d’envoi dédié', d: 'Votre réputation d’expéditeur ne dépend d’aucun autre client.' },
                  { icon: ShieldCheck, t: 'Désinscription conforme dès le premier envoi', d: 'Lien de désinscription dans chaque message, traité automatiquement.' },
